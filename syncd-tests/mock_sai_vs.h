 ...
 */
sai_status_t sai_vs_sai_api_initialize(
    _In_ uint64_t flags,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
sai_status_t sai_vs_sai_api_query(
    _In_ sai_api_t api,
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
sai_status_t sai_vs_sai_api_uninitialize(void);
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
sai_status_t sai_vs_sai_log_set(
    _In_ sai_api_t api,
 ...
 */
sai_object_type_t sai_vs_sai_object_type_query(
 ...
 */
sai_object_id_t sai_vs_sai_switch_id_query(
    _In_ sai_object_id_t object_id);
 ...
 * @return #SAI_STATUS_SUCCESS on success, failure status code on error
 */
sai_status_t sai_vs_sai_dbg_generate_dump(
